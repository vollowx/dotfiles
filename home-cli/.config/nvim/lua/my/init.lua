...
o.tabline = "%!v:lua.require'my.internal.tabline'()"
o.statusline = "%!v:lua.require'my.internal.statusline'()"
o.statuscolumn = "%!v:lua.require'my.internal.statuscolumn'()"
...
augroup('TerminalSettings', {
  'TermOpen',
  {
    ...
    callback = function(info)
      require('my.internal.terminal').setup(info.buf)
    end,
  },
})
...
augroup('TmuxSupport', {
  'UIEnter',
  {
    ...
    callback = function()
      require('my.internal.tmux').setup()
    end,
  },
})
